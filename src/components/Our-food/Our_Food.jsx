        ...
        {ourfood.map((item)=>{
            return(
                <div key= {item.id} className='gap-1  w-[140px] h-[220px] sm:w-[180px] sm:h-[250px] flex flex-col sm:gap-2 items-center cursor-pointer'>
                    ...
                    <button className="bg-orange-500 text-white text-[13px] px-2 py-[5px] w-full rounded-md sm:w-fit sm:text-[16px] sm:px-4 sm:py-1" onClick={handle}>Add to Cart</button>
                </div>
            )
        })}
        </div>
